...
// var builderConfigFiles = WebApplication.CreateBuilder(args);
// // builderConfigFiles.Services.AddOptions();
// // builderConfigFiles.Services.Configure<MyAppSettings>(builderConfigFiles.Configuration);
// // builderConfigFiles.Configuration.AddIniFile("Config.Files/MySettings.ini", optional: false, reloadOnChange: true); //El parametro reloadOnChange es el que hace que si cambia algo de estos archivos la app lo coge
// // var env = builderConfigFiles.Environment.EnvironmentName;
// // builderConfigFiles.Configuration.AddIniFile(
// //     $"Config.Files/MySettings.{env}.ini",  // Ejemplo: MySettings.Development.ini
// //     optional: true,
// //     reloadOnChange: true
// // );

// // builderConfigFiles.WebHost.ConfigureAppConfiguration(config =>
// // {
...
// //EJERCICIOS
// builderConfigFiles.Services.Configure<MyAppSettings>(builderConfigFiles.Configuration);
// builderConfigFiles.Configuration.AddJsonFile("Config.Files/MySettings.json", optional: false, reloadOnChange: true);
// builderConfigFiles.Configuration.AddIniFile("Config.Files/MySettings.ini", optional: false, reloadOnChange: true);
// var app = builderConfigFiles.Build();
